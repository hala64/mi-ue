...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=10, im100=False):
        ...
        if im100:
            self.fc = nn.Linear(num_planes*7*7, num_classes)
        else:
...
def DenseNet121(num_classes=10, im100=False):
    return DenseNet(Bottleneck, [6,12,24,16], growth_rate=32, num_classes=num_classes, im100=im100)
